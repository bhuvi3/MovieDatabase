    ...
    <head>
        ...
        <script type="text/javascript">
            function ajaxfunc() {
                ...
                name = name.replace(' ', '+');
                var queryString = "?rating=" + rating ;
                queryString +=  "&mname=" + name ;
                //var data = "option=" + option + "&name=" + name;
                //alert("rate_get.php" + queryString);
                xhr.open("GET", "rate_get.php" + queryString, true);
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-wrap">
                        ...
                        <div class="form-group">    
                            <form>
                                    <div class="form-group">
                                        <label for="mname" class="sr-only">MName</label>
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Movie Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="mrating" class="sr-only">rating</label>
                                        <input type="text" name="rating" id="rating" class="form-control" placeholder="Rating out of 5">
                                    </div>
                                    <input type="button" id="btn-login" class="btn btn-custom btn-lg btn-block" value="Rate!" onclick="ajaxfunc()">
                            </form>
                        </div>
                    </div>
                </div>
