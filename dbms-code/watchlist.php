    ...
    if(empty($_SESSION['user'])) 
    {
        ...
        if(!empty($_POST)) {
            function add() {
                ...
                $query = "insert into watchlist values($username, $movie_id)";
                ...
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="form-wrap">
                        ...
                        <div class="form-group">    
                            <form role="form" action="rate.php" method="post" id="login-form" autocomplete="off">
                                    <div class="form-group">
                                        <label for="mname" class="sr-only">MName</label>
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Movie Name">
                                    </div>
                                    <input type="submit" id="btn-login" class="btn btn-custom btn-lg btn-block" value="Add to watchlist!">
                            </form>
                        </div>
                    </div>
                </div>
